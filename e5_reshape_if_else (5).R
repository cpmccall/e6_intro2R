...
#https://github.com/cpmccall/e6_intro2R/blob/main/e5_reshape_if_else%20(4).R
...
library(tidyverse)
dsub=d %>% group_by(birthYear,teamID) %>% summarise(total.HR=sum(HR))
dspread=spread(data=dsub,key=teamID,value=total.HR)
head(dspread)
